...
Attribute MouseHover.VB_Description = "On Mouse Hover Event"
Public Event ValueChange(Newval As Double, Oldval As Double)
Attribute ValueChange.VB_Description = "On Propgbar Value Change Event"
Public Event ProgbarError(ErrVal As Integer, Error As String)
Attribute ProgbarError.VB_Description = "on Progbar Error Event"
Public Event click(Value As Double)
Attribute click.VB_Description = "On progbar click Event"
'*********************************************************************************************
'*********************************************************************************************
...
Attribute DrawBar.VB_Description = "Progbar Drawbar Event"
    If Value > PgMax Then
...
Attribute Updater.VB_MemberFlags = "40"
    Dim X As Double
    Dim cx As Double
    Dim Max As Double
    Dim Min As Double
